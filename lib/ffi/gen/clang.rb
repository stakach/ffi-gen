...
module Clang
  ...
  # (Not documented)
  # 
  # @method module_get_ast_file(module)
  # @param [FFI::Pointer(Module)] module a module object.
  ...
  # (Not documented)
  # 
  # @method module_get_parent(module)
  # @param [FFI::Pointer(Module)] module a module object.
  ...
  # (Not documented)
  # 
  # @method module_get_full_name(module)
  # @param [FFI::Pointer(Module)] module a module object.
  ...
  # (Not documented)
  # 
  # @method module_get_num_top_level_headers(translation_unit_impl, module)
  # @param [TranslationUnitImpl] translation_unit_impl 
  # @param [FFI::Pointer(Module)] module a module object.
  ...
  # (Not documented)
  # 
  # @method module_get_top_level_header(translation_unit_impl, module, index)
  # @param [TranslationUnitImpl] translation_unit_impl 
  # @param [FFI::Pointer(Module)] module a module object.
  ...
  # 
  # <em>This entry is only for documentation and no real method. The FFI::Enum can be accessed via #enum_type(:comment_kind).</em>
  # 
  # === Options:
  # :null ::
  ...
  # 
  # <em>This entry is only for documentation and no real method. The FFI::Enum can be accessed via #enum_type(:comment_inline_command_render_kind).</em>
  # 
  # === Options:
  # :normal ::
  ...
  #   font).
  # 
  # @method _enum_comment_inline_command_render_kind_
  # @return [Symbol]
  # @scope class
  ...
  # 
  # <em>This entry is only for documentation and no real method. The FFI::Enum can be accessed via #enum_type(:comment_param_pass_direction).</em>
  # 
  # === Options:
  # :in ::
  ...
  # 
  # @method _enum_comment_param_pass_direction_
  # @return [Symbol]
  # @scope class
  ...
  # @return [Symbol from _enum_comment_kind_] the type of the AST node.
  # @scope class
  ...
  # @param [Comment] comment a \c CXComment_InlineCommand AST node.
  # @return [Symbol from _enum_comment_inline_command_render_kind_] the most appropriate rendering mode, chosen on command
  ...
  # @param [Comment] comment a \c CXComment_ParamCommand AST node.
  # @return [Symbol from _enum_comment_param_pass_direction_] parameter passing direction.
  # @scope class
  ...
  # @param [FFI::Pointer(**Char_S)] file_paths pointer to an array of file paths containing remapping info.
  ...
  enum :idx_entity_kind, [
    ...
    :x_class, 16,
    :x_namespace, 17,
    :x_namespace_alias, 18,
    :x_static_variable, 19,
    :x_static_method, 20,
    :x_instance_method, 21,
    :x_constructor, 22,
    :x_destructor, 23,
    :x_conversion_function, 24,
    :x_type_alias, 25,
    :x_interface, 26
  ]
  ...
  # @param [FFI::Pointer(**Char_S)] command_line_args 
