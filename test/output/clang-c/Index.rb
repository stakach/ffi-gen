...
module Clang
  ...
  #
  # @method get_file_time()
  # @return [Integer]
  # @scope class
  #
  attach_function :get_file_time, :clang_getFileTime, [], :int
  ...
  # @scope class
  #
  attach_function :find_references_in_file_with_block, :clang_findReferencesInFileWithBlock, [Cursor.by_value, :pointer, :cursor_and_range_visitor_block], :void
